...
def download_audio(url: str, output_dir: Path) -> Path:
    ...
    """
    from graphify.security import validate_network_egress_endpoint, validate_url
    validate_network_egress_endpoint(url, purpose="yt-dlp download", allowed_schemes={"http", "https"})
