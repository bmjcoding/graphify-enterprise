...
This step has two parts: **structural extraction** (deterministic, free) and **semantic extraction** through the approved assistant platform.
...
### Step 8 - Save manifest, clean up, and report
